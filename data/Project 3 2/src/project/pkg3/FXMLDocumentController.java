 ...
 * Contains majority of code and methods
 */
public class FXMLDocumentController implements Initializable {
    /**
     * The following initializes the different elements found in the GUI
     */
    @FXML
    ...
    /**
     * Pay Salesman method: takes in a salesman name from user and generates
     * a paycheck with commission attached.
     */
    @FXML
    ...
    /**
     * Check Invoice method: displays the current inventory of the 
     * distributorship.
     */
    @FXML
    ...
    /**
     * Examine name method: asks user for a part name and displays said part in 
     * output box.
     */
    @FXML
    ...
    /**
     * Examine number method: asks user for a part number and displays said part
     * in output box.
     */
    @FXML
    ...
    /**
     * Add van method: Adds a wan to the current warehouse manager's fleet.
     */
    @FXML
    ...
    /**
     * Add order method: Takes in a file of bike parts and adds them to the 
     * inventory.
     */
    @FXML
    ...
    /**
     * Update inventory method:  Takes in a file of parts to be added to the inventory.
     */
    @FXML
    ...
    /**
     * Sell method: sells a part by name or number, decrementing its quantity.
     */
    @FXML
    ...
    /**
     * Invoice method: generates an invoice.
     */
    @FXML
    ...
    /**
     * Move method: moves parts from one location to another.
     */
    @FXML
    ...
    /**
     * Login method: matches up username and password with an Account object type
     * unlocking tabs.
     */
    @FXML
    ...
    /**
     * Exits program, saving items to a file.
     */
    @FXML
